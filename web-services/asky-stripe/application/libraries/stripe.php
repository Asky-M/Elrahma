...
class stripe
{
    ...
    public function __construct()
    {
        ...
        $this->config['sk_test_9gh4BIVvU43fWXghlaEZitzK'] = $this->config['sk_'.$mode];

        $this->config['pk_test_D2obcFBZLkCjhPOK2GvxXYT9'] = $this->config['pk_'.$mode];


        try {
            // Use Stripe's bindings...
          
          \Stripe\Stripe::setApiKey($this->config['sk_test_9gh4BIVvU43fWXghlaEZitzK']);
